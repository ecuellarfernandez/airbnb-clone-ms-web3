...
@Component
public class GetListingsByHostQueryHandler implements Command.Handler<GetListingsByHostQuery, PagedResult<ListingSummaryDTO>> {
    ...
    @Override
    public PagedResult<ListingSummaryDTO> handle(GetListingsByHostQuery query) {
        return listingService.findByHostId(query.getHostId(), query.getPageable());
    }
}
