...
class ListingDeactivatedHandler(EventHandlerInterface):
    ...
    def execute(self, event_value: dict):
        ...
        audit_log = AuditLog(
            action=UPDATE,
            user_id=user_id,
            description=f"Listing {data} deactivated'",
        ...
        print(f"[EVENT HANDLER] Processed LISTING_DEACTIVATED for listing_id: {data}, "
